                    ...
                    case 6:{
                        ...
                        if (tab!=NULL){
                            ...
                            for(int i=0; i< tab->ls; i++){
                                printf("(%d;%d)", tab[i].col, tab[i].line); //pb
                            }
                        }
                        else{
            ...
            case(6):{// Loading and saving in CSV files
                ...
                switch(choice){
                    ...
                    case(1):{ //Loading from a file
                        ...
                        printf("You can open those files (csv_data directory):");
                        /list_csv_files("csv_data");/ // -> conflict with windows with like FLOAT, INT, DATE ...
